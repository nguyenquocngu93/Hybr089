...
+ '<p class="sub">Torrentio · jac.red · Knaben · Magnetz</p>'
 ...
 + '<div class="btn-row"><button class="btn btn-ghost" onclick="copyUrl()">Copy</button><a class="btn btn-green" href="' + stremioUrl + '" id="slink" onclick="onInstallClick(event)">Install</a></div>'
 + '</div>'
 ...
 + 'function gen(){var c=getCfg();var e=enc(c);var u=location.protocol+"//"+location.host+"/"+e+"/manifest.json";document.getElementById("iurl").textContent=u;document.getElementById("slink").href="stremio://"+u.replace(/^https?:\\/\\//,"");showToast("Config updated!","success")}'

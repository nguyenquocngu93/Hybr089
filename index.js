...
function buildConfigPage(cfg, configStr, pub) {
 ...
 + '.drawer{position:fixed;top:12px;right:12px;bottom:12px;width:min(340px,calc(100vw - 24px));height:auto;background:linear-gradient(165deg,#1a1a2e 0%,#16213e 50%,#0f3460 100%);border:1px solid rgba(255,255,255,0.14);border-radius:20px;z-index:10001;transform:translateX(calc(100% + 24px));transition:transform .38s cubic-bezier(.22,1,.36,1);box-shadow:-8px 8px 40px rgba(0,0,0,0.45);display:flex;flex-direction:column;padding:0;overflow:hidden}'
 + '.drawer.show{transform:translateX(0)}'
 + '.drawer-header{display:flex;align-items:center;justify-content:space-between;padding:18px 18px 12px;border-bottom:1px solid rgba(255,255,255,0.08);flex-shrink:0}'

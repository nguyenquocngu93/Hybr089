...
function buildConfigPage(cfg, configStr, pub) {
 ...
 + '.drawer{position:fixed;top:12px;right:12px;bottom:12px;width:min(340px,calc(100vw - 24px));height:auto;background:rgba(26,26,46,0.72);backdrop-filter:blur(28px);-webkit-backdrop-filter:blur(28px);border:1px solid rgba(255,255,255,0.15);border-radius:20px;z-index:10001;transform:translateX(calc(100% + 28px));transition:transform .4s cubic-bezier(.22,1,.36,1);box-shadow:-12px 12px 48px rgba(0,0,0,0.5),inset 0 1px 0 rgba(255,255,255,0.1);display:flex;flex-direction:column;padding:0;overflow:hidden}'
 + '.drawer.show{transform:translateX(0)}'
 + '.drawer-header{display:flex;align-items:center;justify-content:space-between;padding:18px 18px 14px;border-bottom:1px solid rgba(255,255,255,0.1);flex-shrink:0;background:rgba(255,255,255,0.03)}'
 + '.drawer-header h3{font-size:16px;font-weight:700;background:linear-gradient(135deg,#a78bfa,#60a5fa,#f472b6);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin:0;letter-spacing:-0.2px}'
 ...
 + '.drawer-body{padding:18px;flex:1;overflow-y:auto;position:relative}'
 + '.drawer-body label{display:block;color:rgba(255,255,255,0.55);font-size:11px;margin-bottom:8px;text-transform:uppercase;letter-spacing:1px;font-weight:600}'
 + '.drawer-footer{padding:14px 18px 20px;border-top:1px solid rgba(255,255,255,0.1);flex-shrink:0;background:rgba(255,255,255,0.02)}'

...
function buildConfigPage(cfg, configStr, pub) {
 ...
 + '.url-box{background:rgba(0,0,0,0.3);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:14px 16px;font-family:"SF Mono","Fira Code",monospace;font-size:12px;color:#60a5fa;word-break:break-all;margin-bottom:16px;cursor:pointer;transition:all 0.3s;box-shadow:inset 0 2px 4px rgba(0,0,0,0.2)}'
 + '.url-box:hover{background:rgba(96,165,250,0.08);border-color:rgba(96,165,250,0.3)}'
 ...
 + '.toast-container{position:relative;z-index:10;display:flex;flex-direction:column;align-items:stretch;gap:8px;pointer-events:none;padding:12px 12px 0;flex-shrink:0;min-height:0}'
 + '.toast-container:empty{display:none;padding:0}'
 + '.toast{pointer-events:auto;display:flex;align-items:center;gap:12px;width:100%;padding:12px 14px;background:rgba(28,28,30,0.95);backdrop-filter:blur(24px);-webkit-backdrop-filter:blur(24px);border:1px solid rgba(255,255,255,0.14);border-radius:12px;box-shadow:0 8px 28px rgba(0,0,0,0.4);color:#fff;font-size:13px;font-weight:500;opacity:0;transform:translateY(-12px) scale(0.97);transition:opacity .3s cubic-bezier(.22,1,.36,1),transform .3s cubic-bezier(.22,1,.36,1)}'
 + '.toast.show{opacity:1;transform:translateY(0) scale(1)}'
 + '.toast.hide{opacity:0;transform:translateY(-10px) scale(0.97)}'
 + '.toast-icon{flex-shrink:0;width:26px;height:26px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:13px}'
 ...
 + '.menu-btn{position:absolute;right:14px;top:50%;transform:translateY(-50%);width:42px;height:42px;border:none;border-radius:12px;background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.12);cursor:pointer;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:5px;transition:all .25s cubic-bezier(.22,1,.36,1);z-index:2;box-shadow:inset 0 1px 0 rgba(255,255,255,0.08)}'
 + '.menu-btn:hover{background:rgba(167,139,250,0.22);border-color:rgba(167,139,250,0.45);box-shadow:0 4px 16px rgba(167,139,250,0.25),inset 0 1px 0 rgba(255,255,255,0.12)}'
 + '.menu-btn span{display:block;width:18px;height:2px;background:#e0e0f0;border-radius:2px;transition:all .3s cubic-bezier(.22,1,.36,1)}'
 + '.menu-btn.open span:nth-child(1){transform:translateY(7px) rotate(45deg)}'
 + '.menu-btn.open span:nth-child(2){opacity:0;transform:scaleX(0)}'
 + '.menu-btn.open span:nth-child(3){transform:translateY(-7px) rotate(-45deg)}'
 + '.drawer-overlay{position:fixed;inset:0;background:rgba(10,10,24,0.55);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);z-index:10000;opacity:0;visibility:hidden;transition:opacity .35s cubic-bezier(.22,1,.36,1),visibility .35s}'
 + '.drawer-overlay.show{opacity:1;visibility:visible}'
 + '.drawer{position:fixed;top:12px;right:12px;bottom:12px;width:min(340px,calc(100vw - 24px));height:auto;background:rgba(255,255,255,0.08);backdrop-filter:blur(25px);-webkit-backdrop-filter:blur(25px);border:1px solid rgba(255,255,255,0.15);border-radius:24px;z-index:10001;transform:translateX(calc(100% + 28px));transition:transform .4s cubic-bezier(.22,1,.36,1);box-shadow:-12px 12px 48px rgba(0,0,0,0.5),inset 0 1px 0 rgba(255,255,255,0.1);display:flex;flex-direction:column;padding:0;overflow:hidden}'
 + '.drawer.show{transform:translateX(0)}'
 + '.drawer-header{display:flex;align-items:center;justify-content:space-between;padding:24px 20px 16px;flex-shrink:0}'
 + '.drawer-header h3{color:rgba(255,255,255,0.9);font-size:14px;text-transform:uppercase;letter-spacing:1.5px;font-weight:600;display:flex;align-items:center;gap:8px;margin:0}'
 + '.drawer-header h3::before{content:"";width:4px;height:16px;background:linear-gradient(180deg,#a78bfa,#60a5fa);border-radius:2px}'
 + '.drawer-close{width:36px;height:36px;border:none;border-radius:10px;background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.1);color:rgba(255,255,255,0.7);font-size:18px;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:all .2s}'
 + '.drawer-close:hover{background:rgba(248,113,113,0.2);border-color:rgba(248,113,113,0.35);color:#f87171}'
 + '.drawer-body{padding:0 20px 20px;flex:1;overflow-y:auto;position:relative}'
 + '.drawer-body label{display:block;color:rgba(255,255,255,0.6);font-size:11px;margin-bottom:8px;text-transform:uppercase;letter-spacing:1px;font-weight:600}'
 + '.drawer-footer{padding:16px 20px 24px;border-top:1px solid rgba(255,255,255,0.1);flex-shrink:0}'
 + '</style><style>.logo-wrap{position:relative;display:flex;align-items:center;justify-content:center;gap:14px;margin-bottom:8px;padding:14px 56px 14px 18px;background:rgba(255,255,255,0.08);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:1px solid rgba(255,255,255,0.15);border-radius:20px;box-shadow:0 8px 32px rgba(0,0,0,0.3),inset 0 1px 0 rgba(255,255,255,0.1);transition:transform .3s,box-shadow .3s}.logo-wrap:hover{transform:translateY(-1px);box-shadow:0 12px 40px rgba(0,0,0,0.35),inset 0 1px 0 rgba(255,255,255,0.12)}.logo-icon{flex-shrink:0;filter:drop-shadow(0 6px 16px rgba(167,139,250,0.45));transition:transform .3s}.logo-wrap:hover .logo-icon{transform:scale(1.05)}.logo-text{display:flex;flex-direction:column;gap:1px}.logo-title{font-size:22px;font-weight:800;letter-spacing:-0.5px;background:linear-gradient(135deg,#e0e7ff,#c4b5fd,#f9a8d4);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}.logo-ver{font-size:11px;font-weight:600;color:#a78bfa;opacity:0.85;letter-spacing:1.2px;text-transform:uppercase}</style></head><body><div class="drawer-overlay" id="drawerOverlay" onclick="closeDrawer()"></div><div class="drawer" id="drawer"><div class="toast-container" id="toastContainer"></div><div class="drawer-header"><h3>Install Addon</h3><button class="drawer-close" onclick="closeDrawer()">×</button></div><div class="drawer-body"><label>Manifest URL</label><div class="url-box" id="iurl" onclick="copyUrl()">' + installUrl + '</div><div class="btn-row"><button class="btn btn-ghost" onclick="copyUrl()">Copy</button><a class="btn btn-green" href="' + stremioUrl + '" id="slink" onclick="onInstallClick(event)">Install</a></div></div><div class="drawer-footer"><p style="font-size:12px;color:rgba(255,255,255,0.35);text-align:center;margin:0">Generate config trước, rồi mở menu để cài</p></div></div><div class="wrap">'
 + '<div class="logo-wrap"><div class="logo-icon"><svg width="40" height="40" viewBox="0 0 40 40" fill="none"><defs><linearGradient id="lg" x1="0" y1="0" x2="40" y2="40"><stop offset="0%" stop-color="#c4b5fd"/><stop offset="40%" stop-color="#818cf8"/><stop offset="100%" stop-color="#f472b6"/></linearGradient><linearGradient id="lg2" x1="12" y1="10" x2="30" y2="30"><stop offset="0%" stop-color="#fff" stop-opacity="0.95"/><stop offset="100%" stop-color="#e0e7ff" stop-opacity="0.85"/></linearGradient></defs><rect x="1.5" y="1.5" width="37" height="37" rx="12" fill="url(#lg)"/><rect x="1.5" y="1.5" width="37" height="37" rx="12" fill="url(#lg)" opacity="0.15" stroke="rgba(255,255,255,0.25)" stroke-width="1"/><path d="M15 11.5v17c0 .8.9 1.3 1.6.85l13.2-8.5c.65-.42.65-1.28 0-1.7L16.6 10.65c-.7-.45-1.6.05-1.6.85z" fill="url(#lg2)"/><path d="M11.5 14v12" stroke="#fff" stroke-width="2.2" stroke-linecap="round" opacity="0.45"/><path d="M8.5 16.5v7" stroke="#fff" stroke-width="1.8" stroke-linecap="round" opacity="0.28"/><circle cx="28.5" cy="12.5" r="2.2" fill="#f9a8d4" opacity="0.9"/></svg></div>'
